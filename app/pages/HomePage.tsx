...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
            ...
            {categories.slice(1).map((category) => (
              ...
              >
                <motion.div
                  ...
                  className="bg-gradient-to-br from-sky-50 to-amber-50 rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300 border border-slate-200"
                >
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-sky-600 via-sky-500 to-amber-500">
