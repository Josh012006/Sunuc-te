              ...
              <Card className="p-6">
                ...
                <ul className="space-y-3">
                  {experience.includedItems.map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <Shield className="h-6 w-6 text-sky-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="sticky top-24">
                <Card className="p-6 shadow-xl">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select className="w-full pl-10 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-600">
                  ...
                  <Link to={`/booking/${experience.id}`}>
                    <Button className="w-full bg-gradient-to-r from-sky-600 to-sky-500 hover:from-sky-700 hover:to-sky-600 mb-3" size="lg">
                      Réserver maintenant
                    </Button>
                  </Link>
